...
async function loadData() {
  try {
    const embeddedQuestions = Array.isArray(window.DEFAULT_QUESTIONS_V10) ? window.DEFAULT_QUESTIONS_V10 : null;
    ...
    const questions = await fetch("../data/questions/questions_v10.json").then((response) => response.json());
